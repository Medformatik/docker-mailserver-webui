...
class UpdateEmailRequest {
  ...
  @override
  String toString() => 'UpdateEmailRequest[email=$email, password=$password]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UpdateEmailRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UpdateEmailRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
