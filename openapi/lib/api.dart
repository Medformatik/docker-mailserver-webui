...
part 'model/get_email200_response_data_inner.dart';
part 'model/get_email200_response_data_inner_alias_inner.dart';
part 'model/get_email200_response_data_inner_quota.dart';
part 'model/get_email200_response_data_inner_restriction.dart';
part 'model/get_email200_response_metadata.dart';
part 'model/get_email200_response_metadata_request.dart';
